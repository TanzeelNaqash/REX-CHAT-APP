...
// export const CALL_ROUTES = "api/call"
// export const INITIATE_CALL_ROUTE = `${CALL_ROUTES}/initiate`
// export const ACCEPT_CALL_ROUTE = `${CALL_ROUTES}/accept`
// export const REJECT_CALL_ROUTE = `${CALL_ROUTES}/reject`
// export const END_CALL_ROUTE = `${CALL_ROUTES}/end`